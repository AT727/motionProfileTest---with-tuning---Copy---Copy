...
public class TrajectoryGenerator {
    // TODO tune
    private static final double kMaxVel = Constants.kMaxVel;
    private static final double kMaxAccel = Constants.kMaxAccel;
    private static final double kMaxCentripetalAccel = Constants.kMaxCentripetalAccel;
    private static final double kMaxVoltage = Constants.kMaxVoltage;
    ...
    public class TrajectorySet {
        ...
        private Trajectory<TimedState<Pose2dWithCurvature>> getTestTrajectory() {
            ...
            waypoints.add(new Pose2d(-50, 0, Rotation2d.fromDegrees(0)));
